...
const CreateChildTaskModalContext = createContext<CreateChildTaskModalContextType | undefined>(undefined);

export const CreateChildTaskModalProvider = ({ children }: { children: ReactNode }) => {
...
export const useCreateChildTaskModal = () => {
  ...
  if (context === undefined) {
    throw new Error("useCreateChildTaskModal must be used within a CreateChildTaskModalProvider");
  }
  return context;
};
